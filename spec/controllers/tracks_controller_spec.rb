  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved track as @track" do
        ...
        post :create, {:track => { "name" => "invalid value" }}, valid_session
        assigns(:track).should be_a_new(Track)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested track" do
        ...
        Track.any_instance.should_receive(:update).with({ "name" => "MyString" })
        put :update, {:id => track.to_param, :track => { "name" => "MyString" }}, valid_session
      end
